module powerbi.extensibility.visual {
    ...
    export module OpenLayer3Map {
        ...
        export class OpenLayers3Map implements IMap {
            ...
            constructor(elementId: string, private zoomOnClickLevel: number, private centeringMap, private colorTrails, private tailLength, private tailColors: TailColors) {
